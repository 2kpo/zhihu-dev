...
<script>
    export default {
        ...
        methods:{
            store() {
                axios.post('/api/comment/store',{'body':this.body,'type':this.type,'model':this.model}).then(response => {
                    let comment = {
                        user:{
                            name:Zhihu.name,
                            avatar:Zhihu.avatar
            ...
            getComments(){
                axios.get('/api/'+this.type+'/'+this.model+'/comment',{'body':this.body,'user':this.user}).then(response => {
